...
public final class RecyclerAdminBinding implements ViewBinding {
  @NonNull
  ...
  private RecyclerAdminBinding(@NonNull CardView rootView, @NonNull CardView cardView,
  ...
  @NonNull
  public static RecyclerAdminBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RecyclerAdminBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.recycler_admin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RecyclerAdminBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerAdminBinding((CardView) rootView, cardView, tvDesignation, tvID, tvgmail);
    }
