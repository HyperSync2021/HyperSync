...
public final class RecyclerEmployeeBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static RecyclerEmployeeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RecyclerEmployeeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.recycler_employee, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RecyclerEmployeeBinding bind(@NonNull View rootView) {
